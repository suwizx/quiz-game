...
- แต่ละคนได้ลำดับคำถามสุ่มของตัวเอง กดตอบเดินหน้าเองไม่ต้องรอเพื่อน
- เจอครบทุกข้อแล้วจบเกมของตัวเองทันที ไม่วนกลับไปตอบซ้ำ (รอบสองจำคำตอบได้ ปั่น streak ไม่ยุติธรรม)
  แล้วไปรอที่กระดานคะแนน อันดับยังขยับได้จนกว่าคนอื่นจะเล่นจบ
- เข้าร่วมกลางเกมได้ ยังไม่กดเข้าร่วมก็ยังกลับไปกดที่หน้าเตรียมตัวได้เสมอ (เวลาที่เหลือน้อยกว่าคนอื่น)
